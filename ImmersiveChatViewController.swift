...
//        // Controls container with single horizontal input bar
...
//        
//        // Mic icon in text field (left side)
//        micIconView.translatesAutoresizingMaskIntoConstraints = false
//        micIconView.image = UIImage(systemName: "mic.fill")
//        micIconView.tintColor = UIColor(red: 0.8, green: 0.4, blue: 0.7, alpha: 1.0)
//        micIconView.contentMode = .scaleAspectFit
//        micIconView.isUserInteractionEnabled = true
//        let micTapGesture = UITapGestureRecognizer(target: self, action: #selector(micIconTapped))
//        micIconView.addGestureRecognizer(micTapGesture)
//        inputBackground.addSubview(micIconView)
//        
...
//        sendButton.tintColor = UIColor(red: 0.8, green: 0.4, blue: 0.7, alpha: 1.0)
//        sendButton.backgroundColor = .clear
//        sendButton.addTarget(self, action: #selector(sendButtonTapped), for: .touchUpInside)
//        inputBackground.addSubview(sendButton)
//        
//        // Large mic button (hidden by default, shown during listening)
//        micButton.translatesAutoresizingMaskIntoConstraints = false
//        micButton.backgroundColor = UIColor(red: 0.8, green: 0.4, blue: 0.7, alpha: 1.0)
...
//        micButton.layer.shadowRadius = 20
//        micButton.layer.shadowOpacity = 0.3
//        micButton.addTarget(self, action: #selector(micButtonTapped), for: .touchUpInside)
//        micButton.alpha = 0 // Hidden by default
//        controlsContainer.addSubview(micButton)
//    }
//    
//    private func setupNavigationButtons() {
//        // Only keep the switch to chat button since tab bar will be visible
//        switchToChatButton.translatesAutoresizingMaskIntoConstraints = false
//        switchToChatButton.backgroundColor = UIColor.white.withAlphaComponent(0.85)
//        switchToChatButton.layer.cornerRadius = 18
//        switchToChatButton.layer.borderWidth = 0.8
//        switchToChatButton.layer.borderColor = UIColor(red: 0.8, green: 0.4, blue: 0.7, alpha: 0.3).cgColor
//        switchToChatButton.setTitle("💬", for: .normal)
//        switchToChatButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
//        switchToChatButton.layer.shadowColor = UIColor.black.cgColor
//        switchToChatButton.layer.shadowOffset = CGSize(width: 0, height: 2)
//        switchToChatButton.layer.shadowRadius = 6
//        switchToChatButton.layer.shadowOpacity = 0.1
...
//            
//            // Switch to chat button (top-right corner only)
//            switchToChatButton.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 16),
//            switchToChatButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20),
//            switchToChatButton.widthAnchor.constraint(equalToConstant: 36),
//            switchToChatButton.heightAnchor.constraint(equalToConstant: 36),
//            
...
//            
//            // Mic icon (left side)
//            micIconView.leadingAnchor.constraint(equalTo: inputBackground.leadingAnchor, constant: 20),
//            micIconView.centerYAnchor.constraint(equalTo: inputBackground.centerYAnchor),
//            micIconView.widthAnchor.constraint(equalToConstant: 24),
//            micIconView.heightAnchor.constraint(equalToConstant: 24),
//            
//            // Text field (center)
//            textField.leadingAnchor.constraint(equalTo: micIconView.trailingAnchor, constant: 15),
...
//            
//            // Large mic button (centered, hidden by default)
//            micButton.centerXAnchor.constraint(equalTo: controlsContainer.centerXAnchor),
//            micButton.centerYAnchor.constraint(equalTo: controlsContainer.centerYAnchor, constant: -40),
...
//        micButton.layer.add(pulseAnimation, forKey: "micPulse")
//        
...
//            stopAvatarGlow()
//            
//            // Show large mic button with animation
//            UIView.animate(withDuration: 0.4, delay: 0, usingSpringWithDamping: 0.7, initialSpringVelocity: 0.5) {
//                self.micButton.alpha = 1.0
//                self.inputContainer.alpha = 0.4
//            }
//            
//            startMicPulseAnimation()
//            micButton.backgroundColor = UIColor(red: 0.9, green: 0.3, blue: 0.6, alpha: 1.0)
//            
//            // Simulate speech recognition ending after 5 seconds
...
//        micButton.backgroundColor = UIColor(red: 0.8, green: 0.4, blue: 0.7, alpha: 1.0)
//        
//        // Simulate received message and response
...
class ImmersiveChatViewController: UIViewController {
    ...
    // Voice controls - Mic elements removed
    private let inputContainer = UIView()
    private let inputBackground = UIView()
    private let textField = UITextField()
    private let sendButton = UIButton()
    ...
    private func setupControls() {
        // Controls container with simple horizontal input bar
        controlsContainer.translatesAutoresizingMaskIntoConstraints = false
        view.addSubview(controlsContainer)
        ...
        // Text field with spiritual placeholder - No mic icon
        textField.translatesAutoresizingMaskIntoConstraints = false
        textField.placeholder = "What do you want to talk about?"
        textField.font = UIFont.systemFont(ofSize: 16, weight: .medium)
        textField.textColor = UIColor(red: 0.2, green: 0.2, blue: 0.2, alpha: 1.0)
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            // Text field (starts from left with padding, no mic icon)
            textField.leadingAnchor.constraint(equalTo: inputBackground.leadingAnchor, constant: 20),
            textField.trailingAnchor.constraint(equalTo: sendButton.leadingAnchor, constant: -15),
            textField.centerYAnchor.constraint(equalTo: inputBackground.centerYAnchor),
